...
//scrolling action button to left
$(document).ready(function () {
    var windowWidth = $(window).width();
    var buttonsBar = $('#titlebar_right');
    var buttonsBarWidth = buttonsBar.width();
    var buttonBarPosition = windowWidth - buttonsBarWidth - 10;
    ...
    $(window).scroll(function () {
        ...
        var buttonBarPosition = windowWidth - buttonsBarWidth - (10 + overflow);
        $(buttonsBar).css({
    ...
    $(window).resize(function () {
        ...
        buttonBarPosition = windowWidth - buttonsBarWidth - 10;
        $(buttonsBar).css({
